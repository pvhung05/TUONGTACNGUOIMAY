### Public Starter Workspace
This starter no longer ships with authentication or user management flows. The landing page and dashboard are public placeholders that you can replace with your own domain screens.
...
Local email tooling is no longer included because password recovery and verification flows were removed from the starter.
